<template>
  <div>
    ...
    <div v-else>
      ...
      <pre>{{ kafedraSingle?.mudir?.length }}</pre>
      <div v-if="kafedraSingle" class="container pb-5">
        <div class="row">
          <div class="col-12 col-lg-9">
            <h1>
              {{ kafedraSingle?.title }}
            </h1>
            <div v-if="kafedraSingle?.mudir" class="graduatorsCards">
              <div>
                <div class="alumni__row d-md-flex">
                  <div class="alumni__img">
                    <img
                      class="img-graduators"
                      :src="kafedraSingle?.mudir?.image_url"
                      alt="Image graduators"
                    />
                  </div>
                  <div class="w-100" style="padding: 0">
                    <div class="content">
                      <div class="st-floor">
                        <h3>{{ kafedraSingle?.mudir?.title }}</h3>
                        <span>{{ kafedraSingle?.mudir?.position }}</span>
                        <div class="line"></div>
                      </div>
                      ...
                      <div class="alumni__link">
                        <div style="display: grid; gap: 12px" class="ps-2">
                          <p
                            v-if="kafedraSingle?.mudir?.reception_days"
                            class="alumni__links"
                            style="
                              display: flex;
                              align-items: center;
                          ...
                          >
                            ...
                            {{ kafedraSingle?.mudir?.reception_days }}
                          </p>
                          <a
                            v-if="kafedraSingle?.mudir?.phone_number"
                            class="alumni__links"
                          ...
                          >
                            ...
                            {{ kafedraSingle?.mudir?.phone_number }}
                          </a>
                          <a
                            v-if="kafedraSingle?.mudir?.email"
                            class="alumni__links"
            ...
            <div>
              ...
              <div v-if="kafedraSingle?.about" class="content__info">
            ...
            <div v-if="kafedraSingle?.staffs.length" >
              ...
              <!-- <b-table
                ...
                striped
                :fields="fields"
                :items="kafedraSingle?.staffs"
                responsive="lg"
                stacked="lg"
              >
                <template v-slot:cell(index)="data">
                  <div
                    class="d-md-flex align-items-center justify-content-center mt-auto"
                  >
                    {{ data.index + 1 }}
                  </div>
                </template>
...
export default {
  ...
  computed: {
    ...
    ...mapState({
      kafedraSingle: (state) => state.facultySingle.kafedraSingle,
    }),
  },
  ...
  async fetch() {
    await this.$store
      .dispatch('facultySingle/fetchKafedraSingle', this.$route.params.slug)
      .catch(() => {})
  },
}
</script>

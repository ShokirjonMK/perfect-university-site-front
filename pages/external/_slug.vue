      ...
      <div class="container">
        <div v-if="conferenceSlug" class="row">
          <div class="col-12 col-md-9 structure-styles pd">
            ...
            <img :src="conferenceSlug.image_url" alt="Conference" />
...
export default {
  ...
  computed: {
      ...
      return [
        {
          ...
          link: `/${this.$i18n.locale}/external`,
        },
        {
    ...
    ...mapState({
      conferenceSlug: (state) => state.courses.externalSlug,
    }),
  },
  async fetch() {
    await this.$store
      .dispatch('courses/fetchExternalSlug', this.$route.params.slug)
      .catch(() => {})
  },
}
</script>

<template>
  <div>
    ...
    <template v-else>
      <div v-if="catalogSingle" class="inside-page">
        <h1>
          {{ catalogSingle.title }}
        </h1>
        <div
          class="time-and-views mb-3 d-flex align-items-center justify-content-between"
        >
          <span class="d-flex align-items-center"
            ...
            {{
              $moment(catalogSingle.publish_date)
                .locale(
                  $i18n.locale == 'sr'
                    ? 'uz-latn'
                    : $i18n.locale == 'sr'
      ...
      return [
        {
          ...
          link: `/${this.$i18n.locale}/course-entrant-page`,
        },
        {

<template>
  <div>
    ...
    <div v-else>
      ...
      <div class="container">
        <div v-if="magazineSlug" class="row">
          <div class="col-12 col-md-9 structure-styles pd">
            <h1>
              {{ magazineSlug.title }}
            </h1>

            <img :src="magazineSlug.image_url" :alt="magazineSlug.title" />

            <div class="single-content" v-html="magazineSlug.description"></div>

            <template v-if="magazineSlug.file">
              <h2>
                {{ $t('related_docs') }}
              </h2>

              <div class="relatedFiles mb-3">
                <a :href="magazineSlug.file" target="_blank">
                  <div>
                    <i>
                      <svg
                        width="20"
                    ...
                    <!--                        d="M15 18.3327H4.99998C4.08331 18.3327 3.33331 17.5827 3.33331 16.666V14.166H4.99998V16.666H15V6.49935L11.8333 3.33268H4.99998V8.33268H3.33331V3.33268C3.33331 2.41602 4.08331 1.66602 4.99998 1.66602H12.5L16.6666 5.83268V16.666C16.6666 17.5827 15.9166 18.3327 15 18.3327Z"-->
                    <!--                        fill="#4EA06B"/>-->
                    <!--                      <path d="M15.4167 6.66602H11.6667V2.91602L15.4167 6.66602Z" fill="#4EA06B"/>-->
                    ...
                    <!--                    </svg>-->
                    <!--                  </i>-->
                    <!--                  <i v-else-if="(item.file_type ==='doc' || item.file_type ==='docx')  ">-->
                    <!--                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">-->
                    <!--                      <path-->
                    ...
                    <!--                        fill="#9FABB9"/>-->
                    <!--                      <path d="M15.4167 6.66797H11.6667V2.91797L15.4167 6.66797Z" fill="#9FABB9"/>-->
                    <!--                      <path fill-rule="evenodd" clip-rule="evenodd"-->
...
export default {
  ...
  computed: {
    links() {
      return [
        {
          title: this.$t('scientific_journals'),
          link: `/science/scientific-magazines`,
        },
        {
          title: this.magazineSlug?.title,
          link: `${this.$i18n.locale}`,
        },
      ]
    },
    ...mapState({
      magazineSlug: (state) => state.report.scientificMagazinesSlug,
    }),
  },
  async fetch() {
    await this.$store.dispatch('report/fetchScientificMagazinesSlug', {

<template>
  <div>
    ...
    <div v-else>
      <div v-if="facultySingle" class="">
        <h1>
          {{ facultySingle.title }}
        </h1>
        <!--          :to="`/structure/stuff/${item.id}`"-->
        <!--          if u have to do slug paste this commet  <h6>{{ item.title }}</h6>-->
        <client-only>
        ...
        <div>
          <template v-if="facultySingle.staffs && facultySingle.staffs.length">
          </template>
          ...
          <b-table
            ...
            striped
            :fields="fields"
            :items="facultySingle.staffs?.slice(1, facultySingle.staffs.length)"
            responsive="lg"
            stacked="lg"
          >
            ...
            <template v-slot:cell(email)="data">
              <div style="position: relative">
                <div
                  style="width: 131px; word-wrap: break-word; cursor: pointer"
      ...
      return [
        {
          ...
          link: `/${this.$i18n.locale}/structure/faculties`,
        },
        {

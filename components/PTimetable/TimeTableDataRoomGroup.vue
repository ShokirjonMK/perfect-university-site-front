<template>
  <div class="table-multiple">
    <div class="table-data">
      <template v-for="(day, index) of data">
        <div
          :key="index"
          class="w-100 table-data__day"
          :class="checkPeriodTime(day)"
          @click="handleDay(day)"
        >
          ...
          >
            ...
            <div
              v-for="(teacher, i) of day.teachers"
              :key="i"
              class="table-data__room"
              :class="{ 'text-white': checkPeriodTime(day) }"
            >
              {{ teacher }}
            </div>
          </div>
